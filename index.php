...
<?php include 'header.php';?>
    ...
    <section class="home">
      <div class="slider-background">
            ...
            <g>
              ...
              <g display="none">
                <image
                  ...
                  width="69"
                  height="65"
                  xlink:href="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAEUAAABBCAYAAACHHGk/AAAACXBIWXMAAAsSAAALEgHS3X78AAAA
        ...
        SUVORK5CYII="
                  transform="matrix(0.9846 0 0 0.9846 841.9875 782.9567)"></image>
                <g display="inline">
                  <linearGradient
                    id="SVGID_4_"
                    gradientUnits="userSpaceOnUse"
        ...
        9rA9bA/bw/Z5bP8VYAAsQvJGHLzKNAAAAABJRU5ErkJggg=="
                  transform="matrix(0.9846 0 0 0.9846 1355.9874 147.9566)"></image>
                <g display="inline">
                  <linearGradient
                    id="SVGID_5_"
                    gradientUnits="userSpaceOnUse"
        ...
        3jXbAAAAAElFTkSuQmCC"
                  transform="matrix(0.9846 0 0 0.9846 211.9874 896.9567)"></image>
                <g display="inline">
                  <linearGradient
                    id="SVGID_6_"
                    gradientUnits="userSpaceOnUse"
              ...
              <g>
                ...
                <g>
                  <image
                    ...
                    width="54"
                    height="51"
                    xlink:href="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAADYAAAAzCAYAAADciPtuAAAACXBIWXMAAAsSAAALEgHS3X78AAAA
        ...
        AAAAAElFTkSuQmCC"
                    transform="matrix(0.9804 0 0 0.9804 870.2711 328.2417)"></image>
                  <g>
                    <linearGradient
                      id="SVGID_26_"
                      gradientUnits="userSpaceOnUse"
        ...
        drzO38de8O5bK2w9nwLzSgBdxF8012krflf/P8aFtRu/6w9eHpfH5XF5vIrjfwIMALqN111XT2n9
        AAAAAElFTkSuQmCC"
                    transform="matrix(0.9804 0 0 0.9804 738.2711 406.2417)"></image>
                  <g>
                    <linearGradient
                      id="SVGID_33_"
                      gradientUnits="userSpaceOnUse"
              ...
              <g>
                ...
                <g>
                  <image
                    ...
                    width="54"
                    height="50"
                    xlink:href="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAADYAAAAyCAYAAAAX1CjLAAAACXBIWXMAAAsSAAALEgHS3X78AAAA
        ...
        RK5CYII="
                    transform="matrix(0.98 0 0 0.98 590.2817 497.2417)"></image>
                  <g>
                    <linearGradient
                      id="SVGID_40_"
                      gradientUnits="userSpaceOnUse"
            ...
            <g id="redblocksparticles">
              <g>
                <linearGradient
                  ...
                  <stop
                    offset="0"
                    style="stop-color: #ffb3b7; stop-opacity: 0" />
        ...
        177rF15v19v1dr29ju1/AgwAjPnYVBycb7QAAAAASUVORK5CYII="
                    transform="matrix(0.9804 0 0 0.9804 1304.2711 607.2417)"></image>
                  <g>
                    <linearGradient
                      id="SVGID_111_"
                      gradientUnits="userSpaceOnUse"
        ...
        CzAAqYTVOPWO2yYAAAAASUVORK5CYII="
                    transform="matrix(0.98 0 0 0.98 1024.2817 776.2417)"></image>
                  <g>
                    <linearGradient
                      id="SVGID_125_"
                      gradientUnits="userSpaceOnUse"
      ...
      <div class="ms-5 me-5">
        <div class="d-flex position-relative" style="z-index: 1">
          <div class="col-12 d-flex flex-column align-items-start">
            ...
            <h5 class="text-white-text mt-3 mb-4" data-aos="fade-right">
              Bringing the Chasm of Financial Literacy in Startup Ecosystem
            </h5>
            <div data-aos="fade-up" data-aos-delay="50">
              <a href="#services" class="btn btn-brand me-2 p-3">Get Started</a>
        ...
        <div class="container">
          <div class="row">
            <div
              ...
              <div class="section-title">
                <h1 class="display-4 fw-semibold about-us-head">About us</h1>
                <div class="line"></div>
                <p class="about-us-head">
                  At FinTech, we're passionate about empowering individuals with
                  the knowledge and resources they need to make informed
                  financial decisions.
                </p>
              </div>
            </div>
          ...
          <div class="row justify-content-between align-items-center">
            <div
              ...
              style="z-index: 1">
              <img
                src="./images/Depositphotos_11632145_L-1024x716.jpg"
                alt="" />
            </div>
            <div data-aos="fade-down" data-aos-delay="150" class="col-lg-5">
              <h1 class="about-us-head">About FinTech</h1>
              <p class="mt-3 mb-4 about-us-head">
                "Fintech, a blend of finance and technology, revolutionizes
                financial services through innovative digital solutions."
              </p>
              <div class="d-flex pt-4 mb-3">
                <div class="iconbox-about me-4">
                  <i
                ...
                <div>
                  <h5 class="about-us-head">Risk Management</h5>
                  <p class="about-us-head">
                    This involves identifying, assessing, and prioritizing risks
              ...
              <div class="d-flex mb-3">
                ...
                <div>
                  <h5 class="about-us-head">Financial Markets</h5>
                  <p class="about-us-head">
                    This encompasses markets where financial securities and
                    commodities are traded, including stock markets, bond
                    markets, and commodities markets, among others.
                  </p>
                </div>
              </div>
              <div class="d-flex">
                ...
                <div>
                  <h5 class="about-us-head">Financial Regulation</h5>
                  <p class="about-us-head">
                    This involves the creation and enforcement of rules and
                    regulations by governmental bodies.
                  </p>
                </div>
              </div>
            </div>
      ...
      <div class="container">
        <div class="row">
          <div
            ...
            data-aos-delay="150">
            <div class="section-title">
              <h1 class="display-4 fw-semibold about-us-head">
                Awesome Services
              </h1>
              <div class="line"></div>
              <p class="about-us-head">
                "Unlock your financial potential with personalized solutions at
                Awesome Svervices – where your goals meet expert guidance."
              </p>
            </div>
          </div>
        </div>
        <div class="row g-4 text-center">
          <div
            ...
            <div class="service theme-shadow p-lg-5 p-4">
              <div class="iconbox">
                <i
                  ><img class="servies-pics" src="images/Services1.webp" alt=""
                /></i>
              </div>
              <div class="mt-5">
                <h3 class="mt-4 mb-3 about-us-head">
                  Curated Fintech Video Library
                </h3>
                <p class="about-us-head">
                  Organize and curate a library of educational videos on fintech
                  topics such as digital payments, blockchain technology,
                  personal finance management, etc. This would serve as a
                  centralized resource for users seeking knowledge about fintech
                  without having to browse through numerous videos on YouTube.
                </p>
              </div>
            </div>
          </div>
          <div
            ...
            <div class="service theme-shadow p-lg-5 p-4">
              <div class="iconbox">
                <i
                  ><img class="servies-pics" src="images/service3.webp" alt=""
                /></i>
              </div>
              <div class="mt-5">
                <h3 class="mt-4 mb-3 about-us-head">
                ...
                <p class="about-us-head">
                  Provide comprehensive guidance and support for aspiring
                  entrepreneurs interested in starting their own fintech
                  ventures. This could include resources on ideation, business
                  planning, funding options, regulatory considerations, and
          ...
          <div
            ...
            <div class="service theme-shadow p-lg-5 p-4">
              <div class="iconbox">
                <i
                  ><img class="servies-pics" src="images/service2.jpg" alt=""
                /></i>
              </div>
              <div class="mt-5">
                <h3 class="mt-4 mb-3 about-us-head">
                  Startup Funding and Investment Platform
                </h3>
                <p class="about-us-head">
                  Establish a platform where fintech startups can connect with
                  potential investors, venture capital firms, angel investors,
                  and crowdfunding platforms to raise funding for their
                  ventures, showcasing their business ideas and investment
                  opportunities.
                </p>
              </div>
            </div>
